        ...
        <div class="col">
            ...
            <form action="{{ route('editNoteSubmit') }}" method="post">
                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="mb-3">
                            <label class="form-label">Note Title</label>                                    <!--Este title se refere a coluna da tabela notes-->
                        ...
                        <div class="mb-3">
                            <label class="form-label">Note Text</label>                                    <!--Este text se refere a coluna da tabela notes-->
